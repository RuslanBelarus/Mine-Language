#Компилятор скриптов для Minecraft датапаков
##Обзор
...
Циклы и таймеры:
text
cycle 20  # Устанавливает скорость выполнения (20 тиков = 1 секунда)
Работа с массивами:
text
create <array> points
...
Требуется строгое соблюдение синтаксиса

Все функции должны быть явно объявлены и закрыты

Переменные имеют локальную область видимости
